...
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	...
	<base href="https://kyivgaz.ua/posluhy-kompanii/bloky-telemetriyi-dlya-indyvidualnykh-lichylnykiv.html"/>
...
<body id="x" class=" fixed sticky-bar off-canvas-right">
	<div id="jm-allpage">
		<div id="jm-page">
...
<div class="custom canvas">
	...
	<form action="/posluhy-kompanii/bloky-telemetriyi-dlya-indyvidualnykh-lichylnykiv.html" method="post" class="form-inline">
...
<section id="jm-main">
	...
	<meta itemprop="inLanguage" content="uk-UA"/>
		...
		<h2 itemprop="name"> Онлайн-запис на прийом для юридичних осіб
												</h2>
							</div>
		...
		<p>Графік прийому: з понеділка по п'ятницю з 10 до 16 години (обід з 13 до 14 год). Зверніть увагу, що один запис на прийом – це один об’єкт. Якщо Ви надаєте документи по декількох об’єктах, забронюйте необхідну кількість часу. Додаткова інформація за номером: (067) 558-29-57. Перелік необхідних документів можете переглянути за посиланням: <a href="https://kyivgaz.ua/images/poperedjennya.pdf" target="_blank"> https://kyivgaz.ua/images/poperedjennya.pdf </a></p>
...
<br>
								<div id="articleKg" itemprop="articleBody" style="margin:auto;">
									...
									<iframe src="https://mynew.kyivgaz.ua/QueueSeason" width="100%" height="800" scrolling="no" frameborder="no" id="iFrameResizer0" style="overflow: hidden;"></iframe>
